...
extension ContiguousArray {
  ...
  ///
  ///     let integers = try ContiguousArray(parsing: &input, count: 16) { input in
  ...
  /// the correct shape:
  ///
  ///     let integers = try ContiguousArray(
  ///       parsing: &input,
  ///       count: 16,
  ...
  ///
  ///     let integers = try ContiguousArray(parsingAll: &input) { input in
  ///         try UInt32(parsingBigEndian: &input)
  ///     }
  ///
  /// You can also pass a parser initializer to this initializer as a value, if it has
